...
\begin{itemize}
    ...
    \item \lstinline|<mark>|
    % \item \lstinline|<pre>|
    \item \lstinline|<blockquote>|
    \item \lstinline|<q>|
    \item \lstinline|<div>...</div>|
    \item \lstinline|<span>...</span>|
    \item \lstinline|<main>...</main>|
    \item \lstinline|<header>...</header>|
    \item \lstinline|<address>...</address>|
    \item \lstinline|<nav>...</nav>|
    \item \lstinline|<section>...</section>|
    \item \lstinline|<article>...</article>|
    \item \lstinline|<aside>...</aside>|
    \item \lstinline|<footer>...</footer>|
...
% There are endless options for learning HTML online. 
